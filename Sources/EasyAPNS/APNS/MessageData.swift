...
public extension Message {
    ...
    public struct Payload: Encodable {
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            if mutableContent {
                try container.encode(1, forKey: .mutableContent)
            }
        }

        public init(alert: Alert? =  nil, badge: Int64? = nil, sound: Sound? = nil, category: String? = nil, contentAvailable: Bool = false, mutableContent: Bool = false, threadId: String? = nil) {
            self.alert = alert
            self.badge = badge
            self.sound = sound
